...
const features = Object.freeze([
  {
    title: 'Branded setup',
    description: 'Invoice details, customer info, and notes in one workflow.',
    icon: 'document' as const,
  },
  {
    title: 'Signatures and logos',
    description: 'Capture signatures and preview logos right in the browser.',
    icon: 'image' as const,
  },
  {
    title: 'Instant PDF',
    description: 'Submit, review, and download a polished PDF in seconds.',
...
<template>
  <div class="min-h-screen bg-zinc-50">
    ...
    <main id="main-content" tabindex="-1">
      <section class="px-5 pb-20 pt-10 sm:px-6 lg:px-8 lg:pb-24 lg:pt-6" aria-labelledby="landing-hero-title">
        <div class="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <div class="mt-16 grid gap-6 border-t border-zinc-200/70 pt-8 sm:grid-cols-3">
          ...
          <div class="relative" aria-label="Invoice preview mockup">
            <div
              ...
              <div class="mt-4 border-t border-zinc-100 pt-4">
                <ul class="divide-y divide-zinc-100 text-sm">
                  <li v-for="item in previewItems" :key="item.name"
              ...
              <div class="mt-4 flex items-center justify-between border-t border-zinc-100 pt-6">
                ...
                <button type="button"
                  ...
                  <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.8"
                    aria-hidden="true">
                    <path d="M10 4v9m0 0 3.5-3.5M10 13 6.5 9.5M5 16h10" stroke-linecap="round"
      ...
      <section id="features" class="px-5 py-6 sm:px-6 lg:px-8" aria-labelledby="features-title">
        <div class="mx-auto max-w-6xl">
          ...
          <div class="mt-12 grid gap-x-10 gap-y-12 sm:grid-cols-3">
            <article v-for="feature in features" :key="feature.title">
              ...
              <h3 class="mt-5 text-lg font-semibold text-zinc-950">{{ feature.title }}</h3>
          ...
          <div>
            ...
            <ul class="mt-8 space-y-5">
              <li v-for="point in differentiators" :key="point.title" class="flex gap-3">
                <svg viewBox="0 0 20 20" class="mt-1 h-5 w-5 shrink-0 fill-none stroke-emerald-600" stroke-width="2"
                  aria-hidden="true">
                  <path d="m4 10 4 4 8-8" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <div>
                  <h3 class="font-medium text-zinc-900">{{ point.title }}</h3>
                  <p class="mt-1 text-sm text-zinc-600">{{ point.description }}</p>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ol class="mt-8 space-y-6">
              <li v-for="(step, index) in steps" :key="step.title" class="flex gap-4">
                ...
                <div>
                  <h3 class="font-medium text-zinc-900">{{ step.title }}</h3>
